...
#' @export
responsiveCircle <- function(id=NULL, borderColor=NULL, borderWidth=NULL, childColor=NULL, colors=NULL, data=NULL, defs=NULL, enableLabels=NULL, fill=NULL, labelTextColor=NULL, labelsFilter=NULL, labelsSkipRadius=NULL, margin=NULL, motionConfig=NULL, padding=NULL, zoomedId=NULL) {
